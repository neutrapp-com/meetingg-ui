...
<div class="text-gray-400 flex flex-col noselect">
    <div @click="open" :class="isOpen ? 'bg-light bg-opacity-5' : ''" class="w-full p-1 cursor-pointer rounded-lg flex  justify-between">
        ...
        <div class="bg-light bg-opacity-5 w-12 h-12 p-1 rounded-lg items-center justify-center flex border border-white border-opacity-5">
            {{getItemsCount}}
        </div>
    </div>
